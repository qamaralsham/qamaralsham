// ==============================================
// parchiverm-.js v1 — أرشفة الرسائل الخاصة
// ==============================================
//  آخر 100 رسالة ← user_private_messages
//  الأقدم ← private_archive
//  المستخدم يرى 100، الملك يرى الكل
// ==============================================
...
var KEEP_RECENT = 100;
var RUN_INTERVAL_MS = 6 * 60 * 60 * 1000; // 6 ساعات
var FIRST_RUN_DELAY_MS = 3 * 60 * 1000;   // 3 دقائق
...
/* تجنّب المعالجة المزدوجة (نفس المحادثة مرتين) */
...
log('done — moved '+totalMoved+' msgs across '+totalConv+' conversations ('+processed+' pairs)');
return {moved:totalMoved,conv:totalConv,pairs:processed};
}
