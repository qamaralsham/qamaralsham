// ==============================================
// قمر الشام - دوال مساعدة (v3)
// Qamar Al Sham - Utilities v3
// ==============================================
...
/**
 * توليد كود البصمة الفريد لكل عضو
 * مثال: EM·4K7
 * - EM = أول حرفين من الاسم (كابيتال)
 * - · = فاصل مميز
 * - 4K7 = 3 أحرف من hash الـ UID
 */
...
/**
 * استخراج كود البصمة من نص
 * مثال: "شاهد EM·4K7" → "EM·4K7"
 */
...
console.log('📦 Utils v3 loaded — Security + User Code 🔑');