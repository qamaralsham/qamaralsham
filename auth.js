// ==============================================
// قمر الشام - نظام الدخول والمصادقة (v8.3)
// Qamar Al Sham - Auth v8.3 (User Code + Queen Order)
// ==============================================
// ✅ v8.3:
//   1. دعم queenOrder للملكات (1 = الأولى، 2 = الثانية)
//   2. باقي السلوك كما هو في v8.2
// ==============================================
    ...
    try {
        ...
        if (typeof db !== 'undefined' && db) {
            ...
            if (snapshot.exists()) {
                ...
                // ✅ v8.3: ضمان queenOrder للملكات
                if (userData.rank === 'Queen' && !userData.queenOrder) {
                    userData.queenOrder = 1;
                    db.ref('users/' + firebaseUser.uid + '/queenOrder').set(1).catch(() => {});
                }
            ...
            if (!currentUser || currentUser.uid !== firebaseUser.uid) {
                try {
                    ...
                    if (snap.exists()) {
                        ...
                        console.log('🔄 Auth restored:', currentUser.name, '| Rank:', currentUser.rank, '| QueenOrder:', currentUser.queenOrder || '-');
                    }
                } catch (e) {
...
window.addEventListener('DOMContentLoaded', () => {
    loadSession();
    startAuthListener();
    console.log('📦 Auth.js v8.3 loaded — Queen Order support 👸');
});
